...
\normalsize Operating concept: on-board computer powered from launch}
...
the on-board computer (OBC) is powered from launch. A coupled three-block model
(external environment, enclosure-wall conduction, and the two-dimensional axisymmetric
internal field) is solved over the ascent-to-apogee mission window from a cold-night
initial temperature of $+5\degC$. All seventeen payload components remain within their
operating temperature limits for the full analysed window, with a minimum cold-side
operating margin of $+9.0\degC$. The thermal design is assessed \textbf{GO} for flight.
\end{abstract}
...
operating concept the OBC (Jetson Orin Nano, $7\unit{W}$) is powered from launch and
remains active throughout the analysed window; all other payload loads are likewise
active from launch. The resulting free-stream temperature and external convective
...
cools with the falling ambient as the internal convective coupling weakens with
altitude. Component temperature histories are given in Fig.~\ref{fig:traces}, and the
...
times. The Jetson core in the bottom row drives the interior; the upper and outer
components track the cooling wall as the atmosphere thins.}
\label{fig:contour}
\end{figure}
...
\midrule
NVIDIA Jetson Orin Nano        & $\phantom{0}5.0$ & $25.0$ & $-25$ & $+30.0$ & OK \\
Battery (Li-ion / Li-Po)       & $\phantom{0}5.0$ & $11.5$ & $-20$ & $+25.0$ & OK \\
250 GB SSD (NVMe M.2)          & $\phantom{0}5.0$ & $32.9$ & $-40$ & $+45.0$ & OK \\
USB Stick (USB 3.0)            & $\phantom{0}5.0$ & $27.3$ & $-25$ & $+30.0$ & OK \\
STM32 Nucleo F446RE            & $\phantom{0}5.0$ & $\phantom{0}9.5$ & $-40$ & $+45.0$ & OK \\
GNSS Module (u-blox NEO-M9N)   & $\phantom{0}5.0$ & $11.2$ & $-40$ & $+45.0$ & OK \\
SD Card Reader + Card          & $\phantom{0}5.0$ & $10.4$ & $-25$ & $+30.0$ & OK \\
IMU (TDK ICM-20948) $\times2$  & $\phantom{0}5.0$ & $10.9$ & $-40$ & $+45.0$ & OK \\
Env. Sensor MS8607 $\times2$   & $\phantom{0}5.0$ & $10.8$ & $-40$ & $+45.0$ & OK \\
SPOT Trace                     & $\phantom{0}2.2$ & $\phantom{0}7.6$ & $-40$ & $+42.2$ & OK \\
Strato Tracker                 & $\phantom{0}5.0$ & $19.1$ & $-40$ & $+45.0$ & OK \\
Flex 5 Powerbank               & $\phantom{0}2.2$ & $\phantom{0}7.9$ & $-10$ & $+12.2$ & OK \\
Wolfgang GA100 (frame camera)  & $-1.0$ & $10.8$ & $-10$ & $\phantom{0}+9.0$ & OK \\
Prophesee EVK4 (IMX636)        & $\phantom{0}5.0$ & $14.0$ & $-20$ & $+25.0$ & OK \\
Soyo C-Mount Lens              & $\phantom{0}3.0$ & $10.7$ & $-40$ & $+43.0$ & OK \\
GNSS Antenna (ceramic patch)   & $-1.4$ & $\phantom{0}6.9$ & $-40$ & $+38.6$ & OK \\
Wiring \& Connectors           & $\phantom{0}1.4$ & $\phantom{0}8.0$ & $-55$ & $+56.4$ & OK \\
\bottomrule
\end{tabular}
\end{table}

All temperatures are in $\degC$. The minimum operating margin across the payload is
$+9.0\degC$ on the Wolfgang GA100 frame camera, the most cold-limited unit
...
constrained unit at $+12.2\degC$. On the hot side, the warmest component is the SSD at
$32.9\degC$ against an $85\degC$ limit and the Jetson peaks at $25.0\degC$ against
...
shows that with the OBC powered from launch all seventeen payload components remain
...
$+9.0\degC$. On this basis the payload thermal design is assessed
\textbf{GO for flight}.
